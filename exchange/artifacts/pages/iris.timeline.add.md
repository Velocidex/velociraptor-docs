...
parameters:
  ...
  - name: AdditionalAssetId
    description: Comma separated list of IRIS AssetIds of additional assets beside the client to link in this event.
  - name: IocId
    description: Comma separated list of IRIS IocIds to link IOCs in this event.
  - name: Timestamp
  ...
  - name: Tags
    description: List of comma separated tags to be added to the event.
  - name: Description
