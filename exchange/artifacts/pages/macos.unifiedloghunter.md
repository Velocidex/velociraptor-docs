...
Users may need to adjust the `Length` parameter to accommodate a large number of events being returned.
...
parameters:
  ...
  - name: Configuration Profile - Manual Removal
    description: Look for manual removal of a configuration profile
    type: bool
  ...
  - name: Permissions and Access Violations
    description: Looks for TCC permissions and access violations
    type: bool
