...
parameters:
  ...
  - name: Artifact_name
    description: This is the artifact that should be compared and which was executed in the Baseline_Hunt_1 and Hunt_2
  - name: Identifying_column
    description: column of the selected artifact that should be compared
