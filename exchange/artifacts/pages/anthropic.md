...
parameters:
    ...
    - name: Prompt
      type: string
      default: Can you list 10 Windows persistence items in bullet points?
    - name: PromptData
      type: string
      description: The data sent to Anthropic - this data is serialized and added to the prompt
    - name: Model
      type: string
