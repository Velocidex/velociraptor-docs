...
Parse logs from ESET antivirus products. This log contains information about detections made by the ESET modules such as Real-time filesystem protection, Firewall, HIPS, Device Control, HTTP filter, AMSI Scanner etc.
