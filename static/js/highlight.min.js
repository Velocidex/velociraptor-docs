/*!
  ...
  (c) 2006-2026 Ivan Sagalaev and other contributors
...
;return n.forEach((e=>{for(const n in e)t[n]=e[n]})),t}const i=e=>!!e.kind
...
contains:[E]},k=(e,n,t={})=>{const r=s({scope:"comment",begin:e,end:n,
...
},K=Error();function F(e,n,{key:t}){let r=0;const a=e[t],s={},i={}
;for(let e=1;e<=n.length;e++)i[e+r]=a[e],s[e+r]=!0,r+=b(n[e-1])
...
;return e.classNameAliases=s(e.classNameAliases||{}),function t(a,i){const o=a
;if(a.isCompiled)return o
;[O,T,W,I].forEach((e=>e(a,i))),e.compilerExtensions.forEach((e=>e(a,i))),
a.__beforeBegin=null,[B,C,$].forEach((e=>e(a,i))),a.isCompiled=!0;let l=null
;return"object"==typeof a.keywords&&a.keywords.$pattern&&(a.keywords=Object.assign({},a.keywords),
l=a.keywords.$pattern,
delete a.keywords.$pattern),l=l||/\w+/,a.keywords&&(a.keywords=D(a.keywords,e.case_insensitive)),
o.keywordPatternRe=n(l,!0),
i&&(a.begin||(a.begin=/\B|\b/),o.beginRe=n(a.begin),a.end||a.endsWithParent||(a.end=/\B|\b/),
a.end&&(o.endRe=n(a.end)),
o.terminatorEnd=g(a.end)||"",a.endsWithParent&&i.terminatorEnd&&(o.terminatorEnd+=(a.end?"|":"")+i.terminatorEnd)),
...
})),a.starts&&t(a.starts,i),o.matcher=(e=>{const n=new r
;return e.contains.forEach((e=>n.addRule(e.begin,{rule:e,type:"begin"
}))),e.terminatorEnd&&n.addRule(e.terminatorEnd,{type:"end"
}),e.illegal&&n.addRule(e.illegal,{type:"illegal"}),n})(o),o}(e)}function X(e){
return!!e&&(e.endsWithParent||X(e.starts))}const Z=a,Q=s,J=Symbol("nomatch")
;var V=(e=>{const n=Object.create(null),a=Object.create(null),s=[];let i=!0
...
a=e,r=n),void 0===t&&(t=!0);const s={code:r,language:a};w("before:highlight",s)
;const i=s.result?s.result:p(s.language,s.code,t)
;return i.code=s.code,w("after:highlight",i),i}function p(e,t,a,s){
const l=Object.create(null);function c(){if(!k.keywords)return void A.addText(M)
;let e=0;k.keywordPatternRe.lastIndex=0;let n=k.keywordPatternRe.exec(M),t=""
;for(;n;){t+=M.substring(e,n.index)
;const a=E.case_insensitive?n[0].toLowerCase():n[0],s=(r=a,k.keywords[r]);if(s){
const[e,r]=s
;if(A.addText(t),t="",l[a]=(l[a]||0)+1,l[a]<=7&&(R+=r),e.startsWith("_"))t+=n[0];else{
...
})():c(),M=""}function u(e,n){let t=1;for(;void 0!==n[t];){if(!e._emit[t]){t++
;continue}const r=E.classNameAliases[e[t]]||e[t],a=n[t]
;r?A.addKeyword(a,r):(M=a,c(),M=""),t++}}function m(e,n){
...
const n=e[0],r=t.substr(e.index),a=h(k,e,r);if(!a)return J;const s=k
;k.endScope&&k.endScope._wrap?(d(),
A.addKeyword(n,k.endScope._wrap)):k.endScope&&k.endScope._multi?(d(),
u(k.endScope,e)):s.skip?M+=n:(s.returnEnd||s.excludeEnd||(M+=n),
d(),s.excludeEnd&&(M=n));do{
k.scope&&A.closeNode(),k.skip||k.subLanguage||(R+=k.relevance),k=k.parent
}while(k!==a.parent);return a.starts&&m(a.starts,e),s.returnEnd?0:n.length}
let v={};function w(n,s){const o=s&&s[0];if(M+=n,null==o)return d(),0
;if("begin"===v.type&&"end"===s.type&&v.index===s.index&&""===o){
if(M+=t.slice(s.index,s.index+1),!i){const n=Error(`0 width match regex (${e})`)
;throw n.languageName=e,n.badRule=v.rule,n}return 1}
if(v=s,"begin"===s.type)return(e=>{
const n=e[0],t=e.rule,a=new r(t),s=[t.__beforeBegin,t["on:begin"]]
;for(const t of s)if(t&&(t(e,a),a.isMatchIgnored))return _(n)
;return t.skip?M+=n:(t.excludeBegin&&(M+=n),
d(),t.returnBegin||t.excludeBegin||(M=n)),m(t,e),t.returnBegin?0:n.length})(s)
;if("illegal"===s.type&&!a){
const e=Error('Illegal lexeme "'+o+'" for mode "'+(k.scope||"<unnamed>")+'"')
;throw e.mode=k,e}if("end"===s.type){const e=y(s);if(e!==J)return e}
if("illegal"===s.type&&""===o)return 1
;if(O>1e5&&O>3*s.index)throw Error("potential infinite loop, way more iterations than matches")
;return M+=o,o.length}const E=f(e)
;if(!E)throw H(o.replace("{}",e)),Error('Unknown language: "'+e+'"')
;const x=G(E);let N="",k=s||x;const S={},A=new g.__emitter(g);(()=>{const e=[]
...
context:t.slice(j-100,j+100),mode:n.mode,resultSoFar:N},_emitter:A};if(i)return{
...
const n={value:Z(e),illegal:!1,relevance:0,_top:l,_emitter:new g.__emitter(g)}
;return n._emitter.addText(e),n})(e),a=t.filter(f).filter(v).map((n=>p(n,e,!1)))
;a.unshift(r);const s=a.sort(((e,n)=>{
if(e.relevance!==n.relevance)return n.relevance-e.relevance
;if(e.language&&n.language){if(f(e.language).supersetOf===n.language)return 1
;if(f(n.language).supersetOf===e.language)return-1}return 0})),[i,o]=s,c=i
;return c.secondBest=o,c}function m(e){let n=null;const t=(e=>{
...
console.warn(e)),n=e;const r=n.textContent,s=t?u(r,{language:t,ignoreIllegals:!0
}):b(r);e.innerHTML=s.value,((e,n,t)=>{const r=n&&a[n]||t
;e.classList.add("hljs"),e.classList.add("language-"+r)
})(e,t,s.language),e.result={language:s.language,re:s.relevance,
relevance:s.relevance},s.secondBest&&(e.secondBest={
language:s.secondBest.language,relevance:s.secondBest.relevance
}),w("after:highlightElement",{el:e,result:s,text:r})}let h=!1;function _(){
...
;return n&&!n.disableAutodetect}function w(e,n){const t=e;s.forEach((e=>{
e[t]&&e[t](n)}))}
...
}),e.debugMode=()=>{i=!1},e.safeMode=()=>{i=!0},e.versionString="11.2.0"
...
end:/\}/,keywords:t,illegal:/#/},s={begin:/\{\{/,relevance:0},i={
...
contains:[e.BACKSLASH_ESCAPE,r,s,a]},{begin:/([fF][rR]|[rR][fF]|[fF])"""/,
end:/"""/,contains:[e.BACKSLASH_ESCAPE,r,s,a]},{begin:/([uU]|[rR])'/,end:/'/,
...
},o="[0-9](_?[0-9])*",l=`(\\b(${o}))?\\.(${o})|\\b(${o})\\.`,c={
className:"number",relevance:0,variants:[{
begin:`(\\b(${o})|(${l}))[eE][+-]?(${o})[jJ]?\\b`},{begin:`(${l})[jJ]?`},{
...
contains:["self",r,c,i,e.HASH_COMMENT_MODE]}]};return a.contains=[i,c,r],{
name:"Python",aliases:["py","gyp","ipython"],unicodeRegex:!0,keywords:t,
illegal:/(<\/|->|\?)|=>/,contains:[r,c,{begin:/\bself\b/},{beginKeywords:"if",
relevance:0},i,g,e.HASH_COMMENT_MODE,{match:[/def/,/\s+/,n],scope:{1:"keyword",
3:"title.function"},contains:[u]},{variants:[{
match:[/class/,/\s+/,n,/\s*/,/\(\s*/,n,/\s*\)/]},{match:[/class/,/\s+/,n]}],
scope:{1:"keyword",3:"title.class",6:"title.class.inherited"}},{
className:"meta",begin:/^[\t ]*@/,end:/(?=#)|$/,contains:[c,u,i]}]}},
grmr_ruby:e=>{
const n="([a-zA-Z_]\\w*[!?=]?|[-+~]@|<<|>>|=~|===?|<=>|[<>]=?|\\*\\*|[-/+%^&*~`|]|\\[\\]=?)",t={
keyword:"and then defined module in return redo if BEGIN retry end for self when next until do begin unless END rescue else break undef not super class case require yield alias while ensure elsif or include attr_reader attr_writer attr_accessor __FILE__",
built_in:"proc lambda",literal:"true false nil"},r={className:"doctag",
begin:"@[A-Za-z]+"},a={begin:"#<",end:">"},s=[e.COMMENT("#","$",{contains:[r]
}),e.COMMENT("^=begin","^=end",{contains:[r],relevance:10
}),e.COMMENT("^__END__","\\n$")],i={className:"subst",begin:/#\{/,end:/\}/,
keywords:t},o={className:"string",contains:[e.BACKSLASH_ESCAPE,i],variants:[{
...
contains:[e.BACKSLASH_ESCAPE,i]})]}]},l="[0-9](_?[0-9])*",c={className:"number",
...
}].concat(a,s),relevance:0}].concat(a,s);i.contains=p,g.contains=p;const b=[{
begin:/^\s*=>/,starts:{end:"$",contains:p}},{className:"meta",
begin:"^([>?]>|[\\w#]+\\(\\w+\\):\\d+:\\d+>|(\\w+-)?\\d+\\.\\d+\\.\\d+(p\\d+)?[^\\d][^>]+>)(?=[ ])",
starts:{end:"$",contains:p}}];return s.unshift(a),{name:"Ruby",
aliases:["rb","gemspec","podspec","thor","irb"],keywords:t,illegal:/\/\*/,
contains:[e.SHEBANG({binary:"ruby"})].concat(b).concat(s).concat(p)}},
grmr_yaml:e=>{
...
},{className:"number",begin:e.C_NUMBER_RE+"\\b",relevance:0},i,o,r],c=[...l]
;return c.pop(),c.push(a),s.contains=c,{name:"YAML",case_insensitive:!0,
aliases:["yml"],contains:l}},grmr_sql:e=>{
...
begin:u(/\b/,p(...i),/\s*\(/),relevance:0,keywords:{built_in:i}};return{
...
},contains:[{begin:p(...s),relevance:0,keywords:{$pattern:/[\w\.]+/,
keyword:o.concat(s),literal:t,type:r}},{className:"type",
...
contains:[e.BACKSLASH_ESCAPE,n,r]};r.contains.push(s);const i={begin:/\$\(\(/,
...
},contains:[o,e.SHEBANG(),l,i,e.HASH_COMMENT_MODE,a,s,{className:"",begin:/\\"/
...
contains:[t,r,{className:"variable",begin:/\$[A-z]/,end:/[^A-z]/}]},s={
...
className:"params",relevance:0,contains:[r]}]},c={begin:/using\s/,end:/$/,
returnBegin:!0,contains:[a,s,{className:"keyword",
begin:/(using|assembly|command|module|namespace|type)/}]},g={
className:"function",begin:/\[.*\]\s*[\w]+[ ]??\(/,end:/$/,returnBegin:!0,
relevance:0,contains:[{className:"keyword",
begin:"(".concat(n.keyword.toString().replace(/\s/g,"|"),")\\b"),endsParent:!0,
relevance:0},e.inherit(e.TITLE_MODE,{endsParent:!0})]
},d=[g,i,t,e.NUMBER_MODE,a,s,{className:"built_in",variants:[{
...
begin:/[-+*/=%^~]|&&?|\|\|?|!=?|<(?:=>?|<|>)?|>[>=]?/,relevance:0}]}},
grmr_text:e=>({name:"Text",aliases:["text","txt"],contains:[]}),grmr_shell:e=>({
name:"Shell Session",aliases:["console","shellsession"],contains:[{
className:"meta",begin:/^\s{0,3}[/~\w\d[\]()@-]*[>%$#][ ]?/,starts:{
end:/[^\\](?=\s*$)/,subLanguage:"bash"}}]})});const ee=V
