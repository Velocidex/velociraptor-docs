...
the common issues people encounter when deploying the Velociraptor server and
clients and the recommended steps to troubleshoot them.
...
### Collecting server profile information
