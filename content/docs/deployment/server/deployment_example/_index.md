...
This is a typical deployment model for long-term deployments (both cloud-hosted
...
- DNS names are integral to SSO and cloud SSO providers therefore require it.
...
DNS client such as ddclient to update your DNS->IP mapping.

After the dynamic address is created, you need to note the credentials (as
configured with your DDNS provider) for updating the IP address as you will use
these during the interactive configuration process.
