...
<li id="security.secrets_dek">
 <span class="item-name"><i class="bullet-placeholder"></i>
   <div class="reference-key">
     <a target="_blank" href="https://github.com/Velocidex/velociraptor/blob/master/docs/references/server.config.yaml#L1588">
       secrets_dek
     </a>
   </div>
...
<li id="security.vql_must_use_secrets">
 <span class="item-name"><i class="bullet-placeholder"></i>
   <div class="reference-key">
     <a target="_blank" href="https://github.com/Velocidex/velociraptor/blob/master/docs/references/server.config.yaml#L1595">
...
<li id="security.shadowed_env_vars">
 <span class="item-name"><i class="fa fa-angle-right fa-sm category-icon"></i>
   <div class="reference-key">
     <a target="_blank" href="https://github.com/Velocidex/velociraptor/blob/master/docs/references/server.config.yaml#L1601">
       shadowed_env_vars
     </a>
   </div>
