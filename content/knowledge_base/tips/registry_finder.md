...
This works because Velociraptor can glob the registry as if it were a filesystem (See [Filesystem Accessors](/docs/forensic/filesystem/#filesystem-accessors)
