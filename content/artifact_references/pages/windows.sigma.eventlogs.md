...
NOTE: This is a very simple artifact for demonstration purposes
only. For more extensive Sigma rules use the
`Server.Import.CuratedSigma` artifact to import a curated set of
Sigma rules from https://sigma.velocidex.com/
...
# Custom sigma rules can do anything.
