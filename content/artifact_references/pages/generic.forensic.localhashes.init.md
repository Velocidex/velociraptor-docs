...
description: "Sets up a client-side SQLite database for storing file paths, MD5\nhashes, and timestamps generated by\n`Generic.Forensic.LocalHashes.Glob` or similar artifacts.\n"
hidden: true
sitemap:
  disable: true
...
Sets up a client-side SQLite database for storing file paths, MD5
hashes, and timestamps generated by
`Generic.Forensic.LocalHashes.Glob` or similar artifacts.
