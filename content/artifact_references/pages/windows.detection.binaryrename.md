...
parameters:
  ...
  - name: VersionInfoTable
    ...
    default: |
        ...
        ANY,Plink,Plink,"Command-line SSH, Telnet, and Rlogin client",plink.exe
        ANY,PSCP,PSCP,Command-line SCP/SFTP client,pscp.exe
        ANY,PSFTP,PSFTP,Command-line interactive SFTP client,psftp.exe
