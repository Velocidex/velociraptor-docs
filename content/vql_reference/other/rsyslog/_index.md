...
----|-------------|-----
hostname|Destination host to connect to.|string (required)
...
source_hostname|Hostname associated with this message. If omitted we use the current hostname.|string
